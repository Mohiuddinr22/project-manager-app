export default function ProjectsSidebar({onStartAddProject, projects, onSelectProject, selectedProjectId}){
    return(
        <aside className="w-1/3 px-8 py-16 bg-stone-900 text-stone-50 md:w-72 rounded-r-xl">
            ...
            <div>
                <button onClick={onStartAddProject} className="px-4 py-2 text-xs md:text-base rounded-md bg-orange-800 text-stone-300 hover:bg-orange-700 hover:text-stone-50">+Add Project</button>
            </div>
            <ul className="mt-8">
